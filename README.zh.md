...
CapyMeet 的意义在于让会议室管理变得低成本、可自持，而不是依赖昂贵的商业会议室系统、SaaS 订阅或专用门牌硬件。团队可以直接复用手中已有的设备，例如旧平板做门口屏、手机扫码预约、普通电脑做后台管理。软件本身完全开源、免费使用，小团队也能只用现有设备，用很少甚至不新增成本，搭建一套可落地的会议预约和展示系统。
